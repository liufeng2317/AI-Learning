...
def get_batch(data, sequence_length, batch_size, device='cpu'):
    ...
    if device_type == 'cuda':
        ...
        # pinned memory: https://zhuanlan.zhihu.com/p/561544545
...
def train(
    ...
    counter = 0
    for i in range(0, dataset_train.size(0), sequence_length):
        counter += 1
...
def validate(
    ...
    for i in range(0, dataset_valid.size(0), sequence_length):
        counter += 1
        inputs, labels = get_batch(
